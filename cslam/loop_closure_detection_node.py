...
class LoopClosureDetection(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(
            namespace='',
            parameters=[('frontend.similarity_threshold', 0.0),
                        ('frontend.global_descriptor_technique', "global_descriptors"),
                        ('frontend.netvlad.pca_checkpoint', ''), ('frontend.nn_checkpoint', ''),
                        ('robot_id', 0), ('max_nb_robots', 0),
